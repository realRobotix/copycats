    ...
    public static @NotNull DataFixesInternals get() {
        if (instance == null) {
            ...
            if (latestVanillaSchema == null) {
                Copycats.LOGGER.warn("[Copycats+ DFU] Failed to initialize! Either someone stopped DFU from initializing,");
                Copycats.LOGGER.warn("[Copycats+ DFU] or this Minecraft build is hosed.");
                Copycats.LOGGER.warn("[Copycats+ DFU] Using no-op implementation.");
