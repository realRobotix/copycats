...
public class CCShapes {
    ...
    public static final VoxelShaper VERTICAL_STAIR_INNER_BOTTOM_RIGHT = shape(0, 0, 0, 16, 16, 8)
            ...
            .add(8, 0, 8, 16, 16, 16)
            .forDirectional(Direction.NORTH);
    public static final VoxelShaper SLOPE = shape(Shapes.empty()).build((voxelShape, direction) -> {
        VoxelShape shape = Shapes.empty();
        shape = Shapes.join(shape, Shapes.box(0, 0, 0, 1, 0.03125, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.0625, 0, 0.9375, 0.09375, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.125, 0, 0.875, 0.15625, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.1875, 0, 0.8125, 0.21875, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.25, 0, 0.75, 0.28125, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.3125, 0, 0.6875, 0.34375, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.375, 0, 0.625, 0.40625, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.4375, 0, 0.5625, 0.46875, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.8125, 0, 0.1875, 0.84375, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.5, 0, 0.5, 0.53125, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.5625, 0, 0.4375, 0.59375, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.625, 0, 0.375, 0.65625, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.6875, 0, 0.3125, 0.71875, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.75, 0, 0.25, 0.78125, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.9375, 0, 0.0625, 0.96875, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.875, 0, 0.125, 0.90625, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.65625, 0, 0.34375, 0.6875, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.03125, 0, 0.96875, 0.0625, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.09375, 0, 0.90625, 0.125, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.15625, 0, 0.84375, 0.1875, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.21875, 0, 0.78125, 0.25, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.28125, 0, 0.71875, 0.3125, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.34375, 0, 0.65625, 0.375, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.40625, 0, 0.59375, 0.4375, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.46875, 0, 0.53125, 0.5, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.84375, 0, 0.15625, 0.875, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.53125, 0, 0.46875, 0.5625, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.59375, 0, 0.40625, 0.625, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.71875, 0, 0.28125, 0.75, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.78125, 0, 0.21875, 0.8125, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.96875, 0, 0.03125, 1, 1), BooleanOp.OR);
        shape = Shapes.join(shape, Shapes.box(0, 0.90625, 0, 0.09375, 0.9375, 1), BooleanOp.OR);

        return shape(shape).forDirectional(Direction.WEST);
    }, Direction.SOUTH);
