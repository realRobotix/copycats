...
public class MultiStateQuadHelperImpl {

    public static <Source extends List<BakedQuad>, Destination extends List<BakedQuad>> void assemblePiece(MultiStateQuadHelper.CopycatRenderContext<Source, Destination> context, int rotation, boolean flipY, MultiStateQuadHelper.MutableVec3 offset, MultiStateQuadHelper.MutableAABB select, MultiStateQuadHelper.MutableCullFace cull) {
    ...
    public static <Source extends List<BakedQuad>, Destination extends List<BakedQuad>> void assemblePiece(MultiStateQuadHelper.CopycatRenderContext<Source, Destination> context, int rotation, boolean flipY, MultiStateQuadHelper.MutableVec3 offset, MultiStateQuadHelper.MutableAABB select, MultiStateQuadHelper.MutableCullFace cull, MultiStateQuadHelper.QuadTransform... transforms) {
        select.rotate(rotation).flipY(flipY);
        offset.rotate(rotation).flipY(flipY);
        cull.rotate(rotation).flipY(flipY);
        for (MultiStateQuadHelper.QuadTransform transform : transforms) {
    ...
    public static <Source extends List<BakedQuad>, Destination extends List<BakedQuad>> void assembleQuad(MultiStateQuadHelper.CopycatRenderContext<Source, Destination> context) {
        for (BakedQuad quad : context.source()) {
    ...
    public static <Source extends List<BakedQuad>, Destination extends List<BakedQuad>> void assembleQuad(MultiStateQuadHelper.CopycatRenderContext<Source, Destination> context, AABB crop, Vec3 move) {
        for (BakedQuad quad : context.source()) {
            assembleQuad(quad, context.destination(), crop, move);
        }
    }

    public static <Source extends List<BakedQuad>, Destination extends List<BakedQuad>> void assembleQuad(MultiStateQuadHelper.CopycatRenderContext<Source, Destination> context, AABB crop, Vec3 move, MultiStateQuadHelper.QuadTransform... transforms) {
        for (BakedQuad quad : context.source()) {
    ...
    public static <Source extends BakedQuad, Destination extends List<BakedQuad>> void assembleQuad(Source src, Destination dest, AABB crop, Vec3 move, MultiStateQuadHelper.QuadTransform... transforms) {
